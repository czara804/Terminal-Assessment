...
companions_groups = { MATRIX => ['Neo', 'Morpheus', 'Trinity'], HOGWARTS_PALS => ['Ron', 'Hermione', 'Neville'], COMPANY => ['Gandalf', 'Thorin', 'Elrond']}
...
companions_choice = prompt.select("What is a quest without some companions? Please select who you would like to accompany you:", %w((Neo, Morpheus, Trinity), (Ron,Hermione,Neville), (Gandalf,Thorin,Elrond))
